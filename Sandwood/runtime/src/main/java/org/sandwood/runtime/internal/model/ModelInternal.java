...
import org.sandwood.runtime.model.InferenceTechnique;
 ...
 * 
 * @param <STATE> the type of the object that will hold the state for the model.
 */
public abstract class ModelInternal<STATE extends CoreModelState> implements Model {
