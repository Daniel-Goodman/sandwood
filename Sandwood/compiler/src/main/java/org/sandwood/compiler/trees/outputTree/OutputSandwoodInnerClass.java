...
public class OutputSandwoodInnerClass extends OutputSandwoodClass {
    ...
    public OutputSandwoodInnerClass(ClassName name, ClassName extended, List<ClassName> interfaces,
            List<OutputSandwoodInnerClass> innerClasses, OutputTree fieldsTree, List<OutputFunction> functions) {
    ...
    public OutputSandwoodInnerClass(ClassName name, List<ClassName> interfaces,
            List<OutputSandwoodInnerClass> innerClasses, OutputTree fieldsTree, List<OutputFunction> functions) {
    ...
    protected void toJavaBody(StringBuilder sb, int indent, Set<String> requiredImports) {
        ...
        for(OutputFunction f:functions)
            f.toJava(sb, indent, requiredImports);
    }
