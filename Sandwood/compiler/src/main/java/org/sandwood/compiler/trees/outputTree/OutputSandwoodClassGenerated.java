...
public class OutputSandwoodClassGenerated extends OutputSandwoodOuterClass {
    ...
    public static OutputSandwoodClassGenerated getClass(ExecutionType target, ModelClassName name,
            PackageName packageName, Map<FunctionName, OutputFunction> functions, OutputTree classFieldsTree,
        ...
        ScratchClass scratch = new ScratchClass(functions.get(AuxFunctionType.SCRATCH_ALLOCATOR.functionName),
                scratchFieldsTree);
    ...
    private OutputSandwoodClassGenerated(ClassName name, PackageName packageName,
            ...
            String modelCode, List<OutputFunction> gettersAndSetters, OutputTree classFieldTree, ClassName stateName,
    ...
    private void addConstructor(StringBuilder sb, int indent, Set<String> requiredImports) {
        ...
        sb.append("\n");
        addIndent(sb, indent);
        sb.append("public " + getName() + "(" + processImport(stateName, requiredImports)
