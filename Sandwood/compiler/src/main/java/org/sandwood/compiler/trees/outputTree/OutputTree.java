...
public abstract class OutputTree extends Tree<OutputTree> {
    ...
    public static <A extends ObjectVariable<A>, X extends Variable<X>> OutputGetField<A, X> getField(
            OutputTreeReturn<A> tree, VariableDescription<X> fieldDesc) {
        return new OutputGetField<>(tree, fieldDesc);
    }

    public static <A extends ObjectVariable<A>, X extends Variable<X>> OutputSetField<A, X> setField(
            OutputTreeReturn<A> objectTree, VariableDescription<X> fieldDesc, OutputTreeReturn<X> value,
            String comment) {
