...
public abstract class IRTree extends Tree<IRTree> {
    ...
    protected static class VariableTracking {
        ...
        public void addTree(IRTree tree, Set<String> inScope, Set<String> used) {
            /*
             * TODO this could be improved on by having a mapping of sets to sets, so we only have one instance of each
             * set containing a given set of variables. This will only be an issue if this data structure starts to get
             * too big.
             */
